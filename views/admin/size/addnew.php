      ...
      <main role="main" class="main-content">
        <div class="container-fluid">
          <div class="row justify-content-center">
            <div class="col-md-10">
              <h1 class="h1 mb-2">Thêm Size Giày</h1>
                <div class="card shadow">
                  <div class="card-body">
                        <div class="card shadow mb-4">
                          <div class="card-body">
                            <form action="admin.php?c=size&p=addnew" onsubmit="return loi()" method="post" enctype="multipart/form-data">
                            <div class="form-group row">
                                  <div class="col-sm-4">
                                    <label class="col-form-label col-sm-6 pt-0">Mã</label>
                                    <div class="col-md-12">
                                      <input type="text" style="margin-bottom:10px;width:260px;" class="form-control" name="id" id="id" placeholder="Tên Màu Sắc"></div>
                                  ...
                                  <div class="col-sm-5">
                                    ...
                                    <div class="col-md-12">
                                      <input type="text" style="margin-bottom:10px;width:260px;" class="form-control" id="size" name="size" placeholder="Code màu">
                                      <div style="width:100%;height:20px;" class="loi">
