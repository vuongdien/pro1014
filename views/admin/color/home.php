...
<body class="vertical  dark  ">
        ...
        <div class="container-fluid">
          <div class="row justify-content-center">
            <div class="col-md-12 my-4">
              <h2 class="h1 mb-1">Danh Mục Màu Sắc</h2>
                    ...
                    <div class="toolbar row mb-3">
                        ...
                        <div class="col ml-auto">
                            <div class="dropdown float-right">
                                <a href='admin.php?c=color&p=insert'
    ...
    <script>
      function xacnhan(z){
        ...
        $.ajax({
            url: 'admin.php?c=color&p=xoa',
            type: 'GET',
            data: 'xn=' + z,
            success: function(data) {
                thongbao.innerText = "Bạn có chắc muốn xóa màu "+data+" không?"
                xoa.style.display='block'
                button.href = 'admin.php?c=color&p=remove&id='+z
            }
        });
        return false;
      }
    ...
    <script>
        ...
        function tim(x) {
            ...
            $.ajax({
                url: 'admin.php?c=color&p=search',
                type: 'GET',
                data: 'content=' + x,
                success: function(data) {
      ...
      function xoa() {
          ...
          $.ajax({
              url: 'admin.php?c=color&p=chosedelete',
              type: 'GET',
              data: 'delete=' + check,
              success: function(data) {
                  sanpham.innerHTML = data;
