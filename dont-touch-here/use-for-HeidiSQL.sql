...
-- Dumping data for table pro1014.blog_comment: ~3 rows (approximately)
...
REPLACE INTO `cart` (`user_id`, `product_id`, `size_id`, `quantity`) VALUES
	(1, 1, 38, 1),
	(1, 2, 43, 2);
...
-- Dumping data for table pro1014.order_detail: ~2 rows (approximately)
/*!40000 ALTER TABLE `order_detail` DISABLE KEYS */;
REPLACE INTO `order_detail` (`order_id`, `product_id`, `size_id`, `quantity`, `price`) VALUES
	(1, 7, 38, 1, 750000),
	(1, 14, 38, 1, 1250000);
...
-- Dumping data for table pro1014.product: ~15 rows (approximately)
...
REPLACE INTO `product_comment` (`id`, `product_id`, `user_id`, `content`, `created`, `anhien`) VALUES
...
-- Dumping data for table pro1014.product_detail: ~54 rows (approximately)
/*!40000 ALTER TABLE `product_detail` DISABLE KEYS */;
REPLACE INTO `product_detail` (`product_id`, `size_id`, `quantity`) VALUES
	(1, 38, 26),
	(1, 39, 13),
	(1, 42, 31),
	(2, 36, 45),
...
REPLACE INTO `review` (`id`, `product_id`, `user_id`, `review`, `rate`, `anhien`, `created`) VALUES
...
-- Dumping data for table pro1014.tag_blog: ~8 rows (approximately)
...
-- Dumping data for table pro1014.tag_of_blog: ~10 rows (approximately)
...
-- Dumping data for table pro1014.user: ~5 rows (approximately)
