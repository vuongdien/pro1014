...
--
-- Host: localhost:3306
-- Generation Time: Jun 08, 2021 at 04:59 AM
...
INSERT INTO `blog` (`id`, `user_id`, `title`, `created`, `update`, `thumb`, `description`, `content`, `view`, `show`, `priority`) VALUES
...
INSERT INTO `blog_comment` (`id`, `blog_id`, `user_id`, `content`, `created`) VALUES
...
INSERT INTO `brand` (`id`, `name`, `show`, `priority`) VALUES
(1, 'Nike', NULL, 0),
(2, 'Jordan', NULL, 1),
(3, 'Adidas', NULL, 2),
(4, 'Converse', NULL, 3),
...
(1, 'default_layout', '{\"home\": [\"layouts/header\", \"home/banner\", \"home/features\", \"home/newProduct\", \"home/category\", \"home/product\", \"home/ExclusiveDeal\", \"home/brand\", \"layouts/RelatedPoduct\", \"layouts/Footer\"], \"topmenu\": [[\"Home\", \"home.php\"], [\"Shop\", \"shop.php\"], [\"Blog\", \"blog.php\"], [\"Contact\", \"contact.php\"], [\"Login\", \"account.php\"], [\"Admin\", \"admin.php\"]]}'),
(2, 'layout', '{\"home\": [\"layouts/header\", \"home/banner\", \"home/features\", \"home/newProduct\", \"home/category\", \"home/product\", \"home/ExclusiveDeal\", \"home/brand\", \"layouts/RelatedProduct\", \"layouts/Footer\"]}');
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='Bản khuyến mãi, khuyến mãi sẽ bắt đầu từ start_time, đến hết end_time, trong thời gian khuyến mãi, sản phẩm sẽ được bán với giá deal_price với số lượng quantity.';
...
INSERT INTO `deal_detail` (`deal_id`, `product_id`, `quantity`, `deal_thumb`, `deal_price`, `sold`) VALUES
...
INSERT INTO `order` (`id`, `user_id`, `status`, `created`, `name`, `address`, `phone`, `email`) VALUES
...
CREATE TABLE `product` (
  `id` int(11) UNSIGNED NOT NULL COMMENT 'Mã sản phẩm',
...
INSERT INTO `product` (`id`, `name`, `cost`, `price`, `description`, `thumb`, `images`, `update`, `show`, `priority`, `view`, `brand_id`, `color_id`) VALUES
...
INSERT INTO `product_comment` (`id`, `product_id`, `user_id`, `content`, `created`, `anhien`) VALUES
(1, 1, 1, 'Giày đẹp lắm!!', '2020-11-18 23:50:27', 1),
(2, 1, 2, 'Giày quá đẹp. <3 <3', '2020-11-18 22:38:28', 1),
(3, 2, 3, 'Giao hàng cực nhanh', '2020-11-18 21:33:29', 1),
(4, 1, 3, 'Shop uy tính', '2020-11-18 14:38:29', 1);
...
INSERT INTO `product_detail` (`product_id`, `size_id`, `quantity`) VALUES
(1, 38, 26),
(1, 39, 13),
(1, 42, 31),
(2, 36, 45),
...
INSERT INTO `review` (`id`, `product_id`, `user_id`, `review`, `rate`, `anhien`, `created`) VALUES
(1, 1, 1, 'Giày tốt', 5, 2, '2020-12-16 08:25:50'),
(2, 1, 2, 'Giày đẹp', 4, 1, '2020-12-16 08:25:51');
...
INSERT INTO `slider` (`id`, `product_id`, `img`, `description`, `title`, `show`, `priority`) VALUES
...
INSERT INTO `tag_blog` (`id`, `name`, `show`, `priority`) VALUES
...
--
-- Table structure for table `tag_of_blog`
--

CREATE TABLE `tag_of_blog` (
  `blog_id` int(11) UNSIGNED NOT NULL,
  `tag_id` int(11) UNSIGNED NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

--
-- Dumping data for table `tag_of_blog`
--

INSERT INTO `tag_of_blog` (`blog_id`, `tag_id`) VALUES
(1, 1),
(1, 3),
(2, 17),
(3, 18),
...
INSERT INTO `tag_product` (`id`, `name`, `show`, `priority`) VALUES
...
INSERT INTO `user` (`id`, `username`, `password`, `email`, `phone`, `created`, `birthday`, `fullname`, `avartar`, `rank`, `address`, `verification_code`) VALUES
...
(4, 'admin', '$2y$10$RdzH.ludsZX6/m2a8.TnZe2N4yT9ioPaIIiL9DpLGMMuKPiJ4u8Im', 'huyn.dev@gmail.com', NULL, '2020-11-27 10:14:53', NULL, NULL, NULL, 10, NULL, 'NULL'),
(5, 'user', '$2y$10$XRVjjRGu0F8mSucFAZ9QLuHQkG0N1U6dr07QocigaYI7iBuJkCk5.', 'huynguyeexn@gmail.com', NULL, '2020-11-27 10:14:54', NULL, NULL, NULL, 1, NULL, 'NULL');
...
ALTER TABLE `blog_comment`
  ...
  ADD KEY `FK_comment_product` (`blog_id`) USING BTREE;
...
ALTER TABLE `deal_detail`
  ADD KEY `FK_product_of_deal_deal` (`deal_id`),
  ADD KEY `FK_product_of_deal_product` (`product_id`);
...
ALTER TABLE `product`
  ...
  ADD KEY `FK_product_color` (`color_id`) USING BTREE;
...
ALTER TABLE `slider`
  ADD PRIMARY KEY (`id`),
  ADD KEY `FK_slider_product` (`product_id`);
...
--
-- Indexes for table `tag_of_blog`
--
ALTER TABLE `tag_of_blog`
  ADD KEY `FK_tag_of_blog_blog` (`blog_id`),
  ADD KEY `FK_tag_of_blog_tag_blog` (`tag_id`);
...
--
ALTER TABLE `product`
  MODIFY `id` int(11) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'Mã sản phẩm', AUTO_INCREMENT=16;
...
--
ALTER TABLE `blog_comment`
  ADD CONSTRAINT `FK_blog_comment_blog` FOREIGN KEY (`blog_id`) REFERENCES `blog` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `blog_comment_ibfk_2` FOREIGN KEY (`user_id`) REFERENCES `user` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
...
--
-- Constraints for table `deal_detail`
--
ALTER TABLE `deal_detail`
  ADD CONSTRAINT `FK_product_of_deal_deal` FOREIGN KEY (`deal_id`) REFERENCES `deal` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `FK_product_of_deal_product` FOREIGN KEY (`product_id`) REFERENCES `product` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
...
ALTER TABLE `product`
  ...
  ADD CONSTRAINT `FK_product_color` FOREIGN KEY (`color_id`) REFERENCES `color` (`id`) ON DELETE SET NULL ON UPDATE CASCADE;
...
--
ALTER TABLE `product_detail`
  ADD CONSTRAINT `FK__product` FOREIGN KEY (`product_id`) REFERENCES `product` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
...
--
ALTER TABLE `slider`
  ADD CONSTRAINT `FK_slider_product` FOREIGN KEY (`product_id`) REFERENCES `product` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Constraints for table `tag_of_blog`
--
ALTER TABLE `tag_of_blog`
  ADD CONSTRAINT `FK_tag_of_blog_blog` FOREIGN KEY (`blog_id`) REFERENCES `blog` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `FK_tag_of_blog_tag_blog` FOREIGN KEY (`tag_id`) REFERENCES `tag_blog` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
...
ALTER TABLE `tag_of_product`
  ...
  ADD CONSTRAINT `FK_tag_of_product_tag` FOREIGN KEY (`tag_id`) REFERENCES `tag_product` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
COMMIT;
