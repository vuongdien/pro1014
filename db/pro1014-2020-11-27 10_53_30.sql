...
REPLACE INTO `product_comment` (`id`, `product_id`, `user_id`, `content`, `created`) VALUES
	(1, 1, 1, 'Giày đẹp lắm!!', '2020-11-18 23:50:27'),
	(2, 1, 2, 'Giày quá đẹp. <3 <3', '2020-11-18 22:38:28'),
	(3, 2, 3, 'Giao hàng cực nhanh', '2020-11-18 21:33:29'),
	(4, 1, 3, 'Shop uy tính', '2020-11-18 14:38:29');
